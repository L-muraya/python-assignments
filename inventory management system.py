...
expiry_date = datetime.now().replace(year=2024, month=4, day=1)  # Assuming April 1, 2024
perishable_product = PerishableProduct("002", "Milk", 20, 2, expiry_date)
print("Perishable Product value:", perishable_product.calculate_value())

digital_product = DigitalProduct("003", "E-book", 5, 10)
